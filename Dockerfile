...
RUN echo "=== Model Verification ===" && \
    ...
    python3 -c "import h5py; f = h5py.File('plant_disease_model.keras', 'r'); print('✓ Model file is valid HDF5'); print('Keys in file:', list(f.keys())); f.close()"
